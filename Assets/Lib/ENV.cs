...
API_URL = "http://compgirls-api.herokuapp.com",
GOOGLE_MAPS_KEY = "AIzaSyACtmxnxRymLJh3rhS0wkAaFsFgDNzXLDk",
GOOGLE_MAPS_URL = "https://maps.googleapis.com/maps/api/staticmap?center=PLACE&zoom=15&size=600x300&maptype=terrain&markers=color:red%7CPLACE",
GOOGLE_MAPS_COORD_URL = "https://maps.googleapis.com/maps/api/staticmap?center=PLACE&zoom=19&size=550x500&maptype=terrain&markers=color:red%7CPLACE";
...
// MISC
public static string
FACEBOOK_PAGE = "https://www.facebook.com/pages/Museu-Vivo-Da-Ci%C3%AAncia-E-Tecnologia/268725396564027?ref=br_rs",
